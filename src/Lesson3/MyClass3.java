...
/**
 * Created by ArchAngelo on 31.01.2017.
...
public class MyClass3 {
    ...
    public static void guessTheWord(String[] words) {
        ...
        int minLength;
        do {
            System.out.printf("Enter the guessed word \n", questWord);  //questWord for testing purpose only
    ...
    public static boolean isExit() {
        Scanner scn = new Scanner(System.in);
        System.out.println("Wants to play \"Guess The Number\" once more (Y/N)?");
    ...
    public static int getNumber() {
        ...
        Scanner scn = new Scanner(System.in);
        do {
            System.out.printf("Enter a guess number from %d to %d please \n", minimum, maximum, quest); //quest for testing purpose only
